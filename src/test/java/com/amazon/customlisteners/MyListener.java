...
public class MyListener extends BaseTest implements ITestListener,IAnnotationTransformer{
	...
	public void onTestStart(ITestResult result) {
	  ...
	  public void onTestFailure(ITestResult result) {
		  ...
		  DateTimeFormatter formatter = DateTimeFormatter.ofLocalizedPattern("yyyyMMdd_HHmmss");
		  ...
		  try{
			  FileUtils.copyFile(fs, new File(System.getProperty("usr.dir")+"src/test/resources/Screenshot/"+dynamicScreenshotName+".png"));
		  }catch(IOException e) {
			  e.printStackTrace();
		  }
	  }
